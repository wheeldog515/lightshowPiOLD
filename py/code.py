...
import glob
import os
import synchronized_lights as lights  #change this to FMsynchronized_lights_class to test fm program
import json
...
class index:
    def GET(self):        
        return render.index()
        #rmod="r"
        #f = open(os.environ['SYNCHRONIZED_LIGHTS_HOME']+'/py/static/index.html', rmod)
        #try:
        #    stream = f.read()
        #    return stream
        #except:
