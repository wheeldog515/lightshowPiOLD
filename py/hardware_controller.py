...
# Get Configurations - Move more of this into configuration manager
_CONFIG = cm.CONFIG
...
def enable_device():
    ...
    try:
        ...
        for key in devices.keys():
            ...
            # Devices below need testing, these should work
            # but could not verify due to lack of hardware
