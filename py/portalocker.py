...
lightshowpi changes
-------------------
Feb 11, 2015 Tom Enos
    - Added LOCK_UN constant
    - For nt changed function lock to lockf
    - flag LOCK_UN passed to lockf calles unlock
      allows not changing lightshowpi code.
