...
echo "sudo python \$SYNCHRONIZED_LIGHTS_HOME/py/code.py" >> $INSTALL_DIR/cron.sh
crontab -l | { cat; echo "@reboot $INSTALL_DIR/cron.sh >> $INSTALL_DIR/test.log"; } | crontab -
sudo /etc/init.d/cron restart

chmod 744 $INSTALL_DIR/cron.sh
